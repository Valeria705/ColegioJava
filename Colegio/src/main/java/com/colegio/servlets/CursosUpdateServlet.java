...
@WebServlet(name = "CursosUpdateServlet", urlPatterns = {"/CursosUpdateServlet"})
public class CursosUpdateServlet extends HttpServlet {
  ...
  @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
      ...
      try {
          ...
          Curso recuAl= new Curso();
          
          recuAl.setIdCurso(request.getParameter("Id_Curso"));
          recuAl.setNomCurso(request.getParameter("Nom_Curso"));
          ...
          capaService.ModificarCurso(recuAl);
